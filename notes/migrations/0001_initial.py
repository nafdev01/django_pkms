    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_type', models.CharField(choices=[('CT', 'Certification'), ('CW', 'Course Work')], max_length=2)),
                ('course_code', models.CharField(default='COSF', max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='notes.course')),
            ],
            options={
                'verbose_name': 'topic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtopic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='notes.subtopic')),
            ],
            options={
                'verbose_name': 'entry',
